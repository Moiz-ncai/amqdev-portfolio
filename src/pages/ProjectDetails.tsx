...
const ProjectDetails = () => {
  ...
  const projectsData: Record<string, any> = {
    ...
    shikayat: {
      ...
      status: 'Completed',
      year: '2024',
      overview: 'Shikayat (شکایت - meaning "complaint" in Urdu) is a comprehensive, AI-powered web application designed to revolutionize how governments and municipalities handle citizen complaints. It transforms the traditional complaint process into an efficient, transparent, and data-driven experience using advanced AI for intelligent classification, sentiment analysis, and priority scoring.',
      features: [
        'AI-Powered Complaint Classification using Facebook BART model',
        'Real-time Sentiment Analysis with priority scoring',
        'Intelligent Department Routing with 10 predefined categories',
        'Interactive Map-based Location Selection',
        'Real-time Complaint Tracking with unique IDs',
        'Advanced Analytics Dashboard with AI insights',
        'Role-based Access Control for Citizens and Officials',
        'Daily AI-Generated Intelligence Summaries',
        'Geographic Heatmaps and Pattern Recognition',
        'Performance Monitoring and Department Analytics'
      ],
      technologies: [
        'FastAPI (Backend)',
      ...
      challenges: 'Building an AI system that could accurately classify citizen complaints in Urdu and English, implementing real-time sentiment analysis for priority scoring, creating an intuitive interface for both citizens and government officials, and ensuring enterprise-grade security with role-based access control.',
      results: '90% reduction in manual complaint categorization time, intelligent prioritization ensuring critical issues get immediate attention, automated routing eliminating misrouting and delays, and real-time analytics enabling data-driven decision making. The system processes complaints with 2-8 second AI classification times and provides comprehensive insights for better governance.',
      images: [],
      liveUrl: '',
      githubUrl: '',
    },
    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 py-20 px-4">
      ...
      <div className="max-w-5xl mx-auto relative z-10">
        ...
        >
          ...
          {/* Placeholder for projects without details */}
          {!project.overview && (!project.features || project.features.length === 0) && (
            <motion.div
              initial={{ opacity: 0, y: 20 }}
              animate={{ opacity: 1, y: 0 }}
              transition={{ duration: 0.6, delay: 0.4 }}
