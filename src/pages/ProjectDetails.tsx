...
// TEMPORARY: Direct data to bypass import issues
    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 py-20 px-4">
      ...
      <div className="max-w-5xl mx-auto relative z-10">
        ...
        >
          ...
          {/* Never show placeholder for MarkIT even if fields are optimized/minified */}
          {!project.overview && !project.features?.length && !project.technologies?.length && id !== 'markit' && (
